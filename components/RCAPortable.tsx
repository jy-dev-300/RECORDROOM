...
const RCA_PORTABLE_SOURCE = require("../assets/white_rca_noarm.png");
const RCA_PORTABLE_TONEARM_SOURCE = require("../assets/white_rca_arm.png");
const VINYL_DISC_SOURCE = require("../assets/vinyl-record-isolated.png");
const RCA_PORTABLE_CREAM = "#F3E9D6";
...
export default function RCAPortable({
  size = 320,
  artworkSource = null,
  isPlaying = false,
  discAnimatedStyle,
  ...
  return (
    <View style={[styles.hero, { width: size, height: size }]}>
      ...
      <View pointerEvents="none" style={styles.playerTonearmOverlayWrap}>
        <Image
          source={RCA_PORTABLE_TONEARM_SOURCE}
          style={[
