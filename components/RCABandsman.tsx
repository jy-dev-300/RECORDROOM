...
const RCA_BANDSMAN_SOURCE = require("../assets/RCA_Bandsman_No_Tonearm.jpg");
const RCA_BANDSMAN_TONEARM_SOURCE = require("../assets/rca_bandsman_tonearm.png");
...
export default function RCABandsman({
  size = 320,
  artworkSource = null,
  isPlaying = false,
  discAnimatedStyle,
  ...
  return (
    <View style={[styles.hero, { width: size, height: size }]}>
      <Image source={RCA_BANDSMAN_SOURCE} style={styles.playerImage} resizeMode="contain" />
      {artworkSource ? (
        <Animated.View
          style={[
            styles.discWrap,
      ...
      <View pointerEvents="none" style={styles.playerTonearmOverlayWrap}>
        <Image
          source={RCA_BANDSMAN_TONEARM_SOURCE}
          style={[
